...
// ============================================================
// NEW: STOCK ALERTS (user_facts category "alert_rules")
// ============================================================
...
export const portfolioRisk = createServerFn({ method: "GET" })
  ...
  .handler(async ({ context }) => {
    ...
    // fetch historical returns for each ticker (simplified: use last 252 days)
...
export const sectorPerformance = createServerFn({ method: "GET" })
  .middleware([requireSupabaseAuth])
  .handler(async () => {
    // Use a set of sector ETFs as proxy (SPDR sectors)
